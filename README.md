...
| **Analyst** | `argo-analysis` | `redcap-data` | The data layer for analysis — export/import records, metadata, files, and audit logs via the API; pull a cleaned cohort export for tables and figures. |
...
argo-qa/redcap-qa             ← continuous completeness QA on the live database
   ↓
argo-analysis/redcap-data     ← export cleaned cohorts for tables, figures, manuscripts
```
